...
init:
    python:
        ...
        def show_cards():
            ...
            ui.text(translation_new["Rival"], style="cards_button",size=15)
            ui.button(clicked=None, xanchor=1.0, xpadding=6, xminimum=200,
                          xpos=card_dx*(n_cards+1)+card_left_dx+button_dx,
            ...
            ui.text(translation_new["Whose_turn"], style="cards_button",size=15)
            ui.button(clicked=None, xanchor=1.0, xpadding=6, xminimum=200,
                          xpos=card_dx*(n_cards+1)+card_left_dx+button_dx,
            ...
            if  cards_state in ["me_defend_1","me_defend_2","me_get","me_select_1","me_select_2"]:
                ui.text(translation_new["Yours"], style="cards_button",size=25)
            if  cards_state in ["rival_defend","rival_get","rival_select"]:
                ui.text(translation_new["Opponents"], style="cards_button",size=25)
            ...
            ui.text(translation_new["Game_phase"], style="cards_button",size=15)
            ui.button(clicked=None, xanchor=1.0, xpadding=6, xminimum=200,
                          xpos=card_dx*(n_cards+1)+card_left_dx+button_dx,
            ...
            if  cards_state in ["me_defend_1","me_defend_2","rival_defend"]:
                ui.text(translation_new["Defence"], style="cards_button",size=25)
            if  cards_state == "me_select_1":
                ui.text(translation_new["Drop"], style="cards_button",size=25)
            if  cards_state in ["me_select_2","rival_select"]:
                ui.text(translation_new["Capture"], style="cards_button",size=25)
            if  cards_state in ["me_get","rival_get"]:
                if  CARD_GAME_WITH_EXCHANGE:
                    ui.text(translation_new["Change"], style="cards_button",size=25)
                else:
                    ui.text(translation_new["Draw_card"], style="cards_button",size=25)
            if  cards_state in ["results"]:
                ui.text(translation_new["Results"], style="cards_button",size=25)
            ...
            ui.text(translation_new["Rounds_left"], style="cards_button",size=15)
            ui.button(clicked=None, xanchor=1.0, xpadding=6, xminimum=200,
                          xpos=card_dx*(n_cards+1)+card_left_dx+button_dx,
            ...
            ui.text(translation_new["Exchanges_left"], style="cards_button",size=15)
            ui.button(clicked=None, xanchor=1.0, xpadding=6, xminimum=200,
                          xpos=card_dx*(n_cards+1)+card_left_dx+button_dx,
            ...
            if  result_status != 'in_progress':
                ...
                if  result_status == 'win':
                    ui.text(translation_new["Win"], style="cards_button",size=72)
                if  result_status == 'draw':
                    ui.text(translation_new["Draw"], style="cards_button",size=72)
